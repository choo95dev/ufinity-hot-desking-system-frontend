...
2. **Seat Availability View**
    - Show availability for the selected date in a list or grid
    - Display AM/PM availability per seat
...
13. **Bulk Booking Flow**
    - Allow selecting multiple dates, time slots, and seats
    - Support bulk booking submission in a single flow
