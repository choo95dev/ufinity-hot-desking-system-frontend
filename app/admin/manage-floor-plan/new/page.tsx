			...
			<div className="max-w-5xl mx-auto p-6 md:p-8">
					...
					<div className="flex items-center gap-3 mb-2">
						...
						<div>
							...
							<p className="text-slate-600 mt-1">
								Add a new floor plan to your workspace
							</p>
						</div>
					</div>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-6">
					...
					<div className="space-y-6">
						...
						{/* Quick Tips */}
						<Card className="shadow-xl border border-slate-200 bg-gradient-to-br from-blue-50 to-cyan-50">
							<CardBody className="p-6">
								<h2 className="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-2">
									<span>💡</span>
									Quick Tips
								...
								<ul className="space-y-3 text-sm text-slate-700">
									<li className="flex gap-2">
										...
										<span>Use descriptive names to easily identify floor plans</span>
									</li>
									<li className="flex gap-2">
										<span className="text-blue-500">•</span>
										<span>Building and Floor fields help organize multiple locations</span>
									</li>
									<li className="flex gap-2">
										<span className="text-blue-500">•</span>
										<span>Image dimensions are optional but recommended for consistency</span>
									</li>
									<li className="flex gap-2">
										<span className="text-blue-500">•</span>
										<span>Set inactive to hide floor plans from public booking</span>
									</li>
								</ul>
							</CardBody>
						</Card>
